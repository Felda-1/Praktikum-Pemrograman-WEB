...
class Crudjs extends MX_Controller {
    ...
    public function debug()
    {
        ...
        $crudjs_path = './uploads/crudjs/';
        $debug_info['upload_folders'] = array(
            'posts' => array(
                'exists' => is_dir($posts_path) ? 'Yes' : 'No',
                'writable' => is_writable($posts_path) ? 'Yes' : 'No'
            ),
            'crudjs' => array(
                'exists' => is_dir($crudjs_path) ? 'Yes' : 'No',
                'writable' => is_writable($crudjs_path) ? 'Yes' : 'No'
            )
        );
        ...
        try {
            ...
            if (!empty($_FILES['image']['name'])) {
                ...
                if ($upload_result['status']) {
                    $data['image'] = 'crudjs/' . $upload_result['file_name'];
                } else {
                    echo json_encode(array(
                        'status' => 'error',
